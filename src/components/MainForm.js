    ...
    <div className="col-lg-6 py-3">
      <div className="row">
          ...
          <div className="row">
            ...
            <div className="col-12 d-sm-block d-none">
              {validNumber ? (
                ...
                <p className="p-2">
                  Scan to Chat (Provide a valid number to obtain your QR code ) 
                </p>
              )}
            </div>
          </div>
        ...
        <div className="col-sm-8">
          <p className="text-dark text-sm">Contact Number</p>
          <input
            onChange={handleOnChange}
            value={number}
            type="tel"
            className="form-control"
            placeholder="Dial it up! We need a 10-digit number"
          />
          <a
            onClick={() => {
            ...
            className={`btn btn-success p-2 text-dark bg-opacity-10 my-3 m-auto w-100 ${
              validNumber ? "" : "disabled"
            }`}
          >
            <i className="bi bi-whatsapp" /> Initiate WhatsApp Conversation
          </a>
          <input
            onChange={(event) => {
            ...
            type="text"
            className="form-control"
            placeholder="Type Name to Save Contact Locally"
          />
          <button
            onClick={saveContact}
          ...
          {error && (
            ...
            Error:  Looks like this name or number already threw a party here!
            </p>
          )}
        </div>
      </div>

...
const Contacts = ({ yourContacts, setYourContacts, setContactHistory }) => {
  ...
  const deleteAllContacts = () => {
    swal({
      title: "Are you certain? No going back!",
      text: "Are you sure? Deleting contacts is like throwing a surprise party for your phone’s loneliness!",
      icon: "warning",
      dangerMode: true,
      buttons: ["No", "Yes"],
    }).then((willDelete) => {
      if (willDelete) {
        ...
        swal({
          title: "Contacts intact! Panic not!",
        });
      }
    });
  };
  ...
  return (
    <div className="col-md-6 py-1">
      <div className="d-flex justify-content-between align-items-center">
        <span className="fs-4 fw-bolder">Contacts</span>
